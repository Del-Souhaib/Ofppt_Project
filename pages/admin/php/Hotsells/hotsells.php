...
$server = 'localhost';
    ...
    if (!$con) {
        ...
        if (!mysqli_stmt_prepare($stmt, $req)) {
            ...
            echo '
            <a href="./addhotsells.php" class="btn btn-success mb-5">Add an hot sell</a>
     ...
     <tr>
       ...
       ';
                ...
                echo ' </td>
       <td>' . $row['Price'] . '</td>
       <td><a href="..\Hotsells\Hotselldetails.php?Id=' . $row['id'] . '" class="btn btn-primary">Details</a></td>
       <td><a href="..\Hotsells\deletehotsell.php?Id=' . $row['id'] . '" class="btn btn-danger">Delete</a></td>
     </tr>';
            }
