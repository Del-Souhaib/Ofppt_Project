...
if (isset($_SESSION['admin'])) {
        ...
        if (!$con) {
            ...
            if (!mysqli_stmt_prepare($stmt, $req)) {
                ...
                if (!mysqli_stmt_execute($stmt)) {
                    ...
                    header('Location:..\Hotsells\hotsells.php');
    ...
    if (!$con) {
        ...
        $req = "SELECT * FROM `hot_sells` INNER JOIN product ON product.Id=hot_sells.id_product WHERE hot_sells.id=? ";
        $stmt = mysqli_stmt_init($con);
        if (!mysqli_stmt_prepare($stmt, $req)) {
            echo '<script>alert("try again")</script>';
        } else {
...
$count = substr_count($row['Pictures'], '|');
            ...
            ?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-5 col-md-4">
                                    <a href="..\Hotsells\hotsells.php" class="btn btn-primary" name="back"
