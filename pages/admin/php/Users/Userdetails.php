                    ...
                    <div class="row">
                        ...
                        <div class="row ">
                                ...
                                <div class="col-lg-10 col-md-10 mb-5">
                                   <img width="200" height="200" src="\Work\school project\images\community\Profiles\<?php echo $row['Picture'] ?>">                                </div>
                            ...
                            <div class="row ">
                                ...
                                <div class="col-lg-3 col-md-6 mb-5">
                                    <input type="text" value="<?php echo $row['First_Name'] ?>" readonly class="form-control">
                                </div>
                                <div class="col-lg-2 col-md-4">
                                    <label for="pet">Last name </label>
                                </div>
                                <div class="col-lg-3 col-md-6 mb-5">
                                    <input type="text" readonly value="<?php echo $row['Last_Name'] ?>" class="form-control">
                                </div>
                                <div class="col-lg-1"></div>
                            </div>
                            <div class="row ">
                                ...
                                <div class="col-lg-3 col-md-6 mb-5">
                                    <input type="text" value="<?php echo $row['Email'] ?>" readonly class="form-control">
                                </div>
                                <div class="col-lg-2 col-md-4">
                                    <label for="Phone">Phone number</label>
                                </div>
                                <div class="col-lg-3 col-md-6 mb-5">
                                    <input type="text" value="<?php echo $row['Phone_number'] ?>" readonly class="form-control">
                                </div>
                                <div class="col-lg-1"></div>
                            </div>
                            <div class="row ">
                                ...
                                <div class="col-lg-3 col-md-6 mb-5">
                                    <input type="text" value="<?php echo $row['Birthday'] ?>" readonly class="form-control">
                                </div>
                                <div class="col-lg-2 col-md-4">
