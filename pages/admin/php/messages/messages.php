...
$server = 'localhost';
    ...
    if (!$con) {
     ...
     <tr>
       ...
       <td>' . $row['Message'] . '</td>
       <td>' . $row['Date'] . '</td>
       <td><a href="..\messages\messagedetails.php?content=' . $row['Message_Content'] . '&Id=' . $row['Id'] . '" class="btn btn-primary" >Details</a></td>
       <td><a href="..\messages\deletemessage.php?content=' . $row['Message_Content'] . '&Id=' . $row['Id'] . '" class="btn btn-danger" >Delete</a></td>
