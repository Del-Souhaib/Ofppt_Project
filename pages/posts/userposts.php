...
function posts()
{
    ...
    $req = "SELECT  post.Id as Postid,post.Text,post.File,post.Date,user.First_Name, user.Last_Name,
    user.Picture FROM user inner JOIN post  WHERE post.Id_User=user.Id AND post.Id_User=?  ORDER BY post.Date DESC ";
    ...
    if (!mysqli_stmt_prepare($stmt, $req)) {
        ...
        while ($row = mysqli_fetch_assoc($res)) {
            ...
            if (!empty($row['File'])) {
                ...
                echo '<img src="../images/community/posts/' . $row['Postid'] . '.' . $img . '" class="card-img-top" alt="...">';
            }
