...
if (!$con) {
    ...
    if (isset($_GET['category'])) {
        ...
        $req0 = "SELECT * FROM `product` WHERE  Pet LIKE ? AND Category LIKE ?";
        if (!mysqli_stmt_prepare($stmt0, $req0)) {
            echo '<script>alert("Try again 2")</script>';
        } else {
            mysqli_stmt_bind_param($stmt0, 'ss', $pet, $cat);
    ...
    <div class="row pb-4 pt-5">
        <div class="col-12">
            <h2 class="bigtitle ">Looking for : ' . $pet . ' ' . $cat . '</h2>
        </div>
    </div>
    <div class="row">
                ';
        ...
        $req0 = "SELECT * FROM `product` WHERE  Pet LIKE ? ";
        if (!mysqli_stmt_prepare($stmt0, $req0)) {
            echo '<script>alert("Try again 2")</script>';
        } else {
            mysqli_stmt_bind_param($stmt0, 's', $pet);
            mysqli_stmt_execute($stmt0);
            if (!$res0 = mysqli_stmt_get_result($stmt0)) {
                echo '<script>alert("Try again 3")</script>';
            } else {
    ...
    <div class="row pb-4 pt-5">
        <div class="col-12">
            <h2 class="bigtitle ">Looking for : ' . $pet . '</h2>
        </div>
    </div>
    <div class="row">
                ';
